scriptCreator = {
    ...
    exportScript = function(scriptName)
        ...
        local scriptExportTable = {
			...
			'function retrieveString(address, gettype)',
			'	local class_name = ""',
			...
			'	return class_name',
			'end',
			'stringsStart = ":" .. string.char(0) .. "mscorlib.dll" .. string.char(0)',
			...
			'			namespace_name = retrieveString(namespace_string_address[1].value)',
			...
			'			end',
			'			field_name = retrieveString(field_name_pointer)',
			'			get_type = {}',
			'			get_type[1] = {}',
